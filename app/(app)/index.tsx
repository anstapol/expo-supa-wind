...
export default function Home() {
	...
	return (
		<View className="flex-1 items-center justify-center bg-background px-8">
			...
			<Text className="mb-8 text-muted-foreground">{user?.email}</Text>
			<Pressable
				className="mb-4 rounded-lg bg-secondary px-6 py-3 active:opacity-80"
			...
			<Pressable
				className="rounded-lg bg-destructive px-6 py-3 active:opacity-80"
				onPress={signOut}
			>
